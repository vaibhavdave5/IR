 ...
 * @author Vaibhav
 */
public class TfIdf_SingleQuery_Stemmed {
    ...
    public RankedDocuments generate(String query) throws FileNotFoundException, IOException {
           ...
           // Read the queries:
                ...
                for(Map.Entry<String,Integer> entry: queryTerms.entrySet()){
                    ...
                    if(!found){
                        continue; // if the query term is not present in index go to next query term.
                    }
                    nk = docIDs.length; 
                ...
                for(Map.Entry<String, Float> entry: map2.entrySet()){
                    ...
                    tfidf_results.put(entry.getKey(), entry.getValue());
    ...
    public static int getN(){
        File folder = new File(Constants.Stemmed_CORPUS);
